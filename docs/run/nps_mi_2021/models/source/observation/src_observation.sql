  ...
  create or replace view `nps-omop-project`.`C_SREDH_NPS_MI_STAGING_SIMPLIFIED_2021_VIEWS_ONLY`.`src_observation`
  OPTIONS()
  as 
...
cast(hub.OBSERVATION_ID as STRING) as SOURCE_SITE_OBSERVATION_ID,
cast(concat(lo.HUB_SITE_PATIENT_SK,'_',hub.OBSERVATION_ID) AS STRING) AS OBSERVATION_ID,
NULL as PROVIDER_ID,
...
CAST(hub.HUB_OBSERVATION_SK AS STRING) AS HUB_OBSERVATION_SK
FROM 
