  ...
  create or replace view `nps-omop-project`.`C_SREDH_NPS_MI_STAGING_SIMPLIFIED_2021_VIEWS_ONLY`.`src_encounter_reason_md_excld_sensitive_data`
  OPTIONS()
  as 
...
cast(sem.REASON as STRING) AS ENCOUNTER_REASONS,
