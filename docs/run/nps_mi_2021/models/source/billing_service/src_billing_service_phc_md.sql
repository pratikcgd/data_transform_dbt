  ...
  create or replace view `nps-omop-project`.`C_SREDH_NPS_MI_STAGING_SIMPLIFIED_2021_VIEWS_ONLY`.`src_billing_service_phc_md`
  OPTIONS()
  as 
...
select * from billing_service_phc_md;
